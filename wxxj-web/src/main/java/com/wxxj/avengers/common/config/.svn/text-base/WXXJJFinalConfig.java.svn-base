package com.wxxj.avengers.common.config;
...
public class WXXJJFinalConfig extends JFinalConfig {
	...
	public void configPlugin(Plugins me) {
		DruidPlugin druidPlugin = new DruidPlugin(getProperty("wxxj.jdbc.url"),
				getProperty("wxxj.jdbc.user"),
				getProperty("wxxj.jdbc.password").trim());
